...
- **Do not** close Phase 1 without `### 1.3 Run instructions` in the pipeline MD — see learnings.md `phase1-run-instructions-required`.
- **Do not** mark an overnight/watch session complete on exit 0 alone — audit charter Phase 0.3 steps vs `results/` artifacts (see learnings.md `overnight-charter-scope-audit`).
