"""
Constants for autonomous-control reward v1 (slides + project deltas).
...
# Outer gate: beyond this distance to target, reward is 0 (no slide penalty, no energy term).
CAMERA_VIEWING_DISTANCE_THRESHOLD = 2500.0 * ureg.km

# Slide v1: optimal (nadir reference) and resolution outer bound — must satisfy d_th > d_op.
...
REWARD_ENERGY_LINEAR_COEFFICIENT = 1.0e6
