"""Apply dt 1.5s profile for modular encoder r2 experiment."""
...
_spec = importlib.util.spec_from_file_location(
    "ml_overnight_sim_constants_encoder",
...
def write_dt_profile(*, train_episodes: int = 50) -> dict[str, Any]:
    payload = {
        "aborted": False,
