"""dt 1.5s profile for Exp 10 MPO safe-mode penalty (re-exports overnight fork)."""
...
_spec = importlib.util.spec_from_file_location(
    "ml_overnight_sim_constants_mpo_safe_mode_penalty",
...
def write_dt_profile(*, train_episodes: int) -> dict[str, Any]:
    payload = {
        ...
        "source": "ml_mpo_safe_mode_penalty",
    }
