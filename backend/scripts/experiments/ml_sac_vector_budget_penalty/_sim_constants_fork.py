"""Fixed dt 1.5s profile for SAC vector budget penalty (Exp 7)."""
...
_spec = importlib.util.spec_from_file_location(
    "ml_overnight_sim_constants_budget",
...
FIXED_BUDGET_DT = _overnight_sim.FIXED_COMPARE_DT
...
def write_fixed_budget_dt_profile(*, train_episodes: int = 50) -> dict[str, Any]:
    profile = FIXED_BUDGET_DT
    payload = {
        "aborted": False,
