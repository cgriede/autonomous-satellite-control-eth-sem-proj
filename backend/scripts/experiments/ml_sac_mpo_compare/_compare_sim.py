"""Fixed dt 1.5s profile for SAC vs MPO compare (no H0 sweep)."""
...
_spec = importlib.util.spec_from_file_location(
    "ml_overnight_sim_constants_compare",
...
def write_fixed_compare_dt_profile(*, train_episodes: int = 20) -> dict[str, Any]:
    profile = FIXED_COMPARE_PROFILE
    payload = {
        "aborted": False,
