"""Fixed dt 1.5s profile for agent-reference pointing (Exp 4)."""
...
_spec = importlib.util.spec_from_file_location(
    "ml_overnight_sim_constants_ref",
...
FIXED_REFERENCE_DT = _overnight_sim.FIXED_COMPARE_DT
...
def write_fixed_reference_dt_profile(*, train_episodes: int = 50) -> dict[str, Any]:
    profile = FIXED_REFERENCE_DT
    payload = {
        "aborted": False,
...
__all__ = [
    ...
    "require_dt_profile",
    "write_fixed_reference_dt_profile",
]
