"""JSON contract helpers for ml_sac_shutter_reward_split."""
...
from _split_frozen import BASELINE_WARMUP_RETURN_MEAN, EXP7_PENALTY_ON_RUN_DIR  # noqa: E402
...
def baseline_exp7_metadata() -> dict[str, Any]:
    run_dir = BACKEND_RUNS / EXP7_PENALTY_ON_RUN_DIR
    summary_path = run_dir / "summary_metrics.json"
    out: dict[str, Any] = {
        "experiment_id": "ml_sac_vector_budget_penalty",
        "arm_id": "penalty_on",
        "run_dir": str(run_dir),
        "reward_note": "enable_shutter_waste_penalty=true; budget-exhausted via fork/production",
    }
