...
\begin{itemize}
  \item a cloud-aware simulation and reward design for rainforest-style overflight;
  \item safety-constrained MPO training and matched baseline evaluation;
  \item qualitative and quantitative comparison of learned versus deterministic capture strategies.
\end{itemize}
